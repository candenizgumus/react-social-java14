                ...
                <div className="left-column">
                    ...
                    <div className="card shadow-sm card-left2 mb-4">
                        ...
                        <div className="card-body">
                                ...
                                <p  className="card-text"> <i style={{width:"30px"}} className="fas fa-calendar-week mr-2"></i>Doğum Tarihi</p>

                                <p className="card-text"> <i style={{width:"30px"}} className="fas fa-user-friends mr-2"></i>Ünvan:</p>
                                <p className="card-text"> <i style={{width:"30px"}} className="far fa-building mr-2"></i>İletişim</p>
                                <p className="card-text"> <i style={{width:"30px"}} className="fas fa-home mr-2"></i>Adres: </p>
                    ...
                    <div className="card shadow-sm card-left3 mb-4">
                        ...
                        <div className="card-body">
                            <h5 className="card-title">Paylaşımlarım<small className="ml-2"></small></h5>
                        ...
                        <div className="card-header bg-transparent">
                            <form className="form-inline">
                                ...
                                <div className="input-group w-100">
                                    <img src='http://picsum.photos/100/100' width={60} height={60} style={{margin:'7px' , borderRadius:'50%'}}/>
